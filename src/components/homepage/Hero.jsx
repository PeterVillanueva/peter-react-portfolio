...
export default function Hero() {
  ...
  return (
    <section id="hero" className="hero relative flex w-full h-screen select-none items-center justify-center" aria-label="hero">
      <div className="z-10 flex flex-col w-full items-center text-title 2xl:text-[9vw] 2xl:space-y-16 font-bold  uppercase text-accent-300">
        <div className="title 2xl:py-0">
